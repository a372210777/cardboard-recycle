...
public class BasicBuyer implements Serializable {
    private static final long serialVersionUID = 4749069307507512535L;

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "`id`")
    @ApiModelProperty(value = "采购商编码，修改时必填")
    private Integer id;
    ...
    @NotBlank
    @ApiModelProperty(value = "采购商状态，数据字典：buyer_status", required = true)
